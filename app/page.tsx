...
export default function HomePage() {
  return (
     <div className="space-y-12">
         ...
         subtitle="Feedback Fusion is where your ideas come to life. Suggest features, vote our"
         >
        ...
        className="bg-white text-blue-600 hover:bg-gray-100"
            >
           <Link href="/feedback/new" className="inline-flex items-center">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">Share your suggestion and features requers with the community</p>
                </CardContent>
              </Card>
               <Card>
                <CardHeader>
